...
const {addLoan,updateinterest,update_loantransaction,getallLoan,getLoanById,discount,deleteLoan,cancelLoan} = require("../Controllers/Loan");
...
//cancelLoan
Loanrouter.put("/cancel/:id",issignin,cancelLoan);
